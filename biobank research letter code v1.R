...
jwt="eyJhbGciOiJSUzI1NiIsImtpZCI6ImFwaS1qd3QiLCJ0eXAiOiJKV1QifQ.eyJpc3MiOiJhcGkub3Blbmd3YXMuaW8iLCJhdWQiOiJhcGkub3Blbmd3YXMuaW8iLCJzdWIiOiJiYXIud29vbGZAZ21haWwuY29tIiwiaWF0IjoxNzM2OTQ3ODUwLCJleHAiOjE3MzgxNTc0NTB9.PEmdg8J0jzEkis9bBv7D366yCBAw2i4UO5dE3uT1FqSBbFAw4czx1GJJ_X20TOjYbpqAKRbVN2RBkca6E02AGG_e7BevQDHj_9-1YY5TJPnkHpFVP60p7_GlvQc0JnLa_F-69shdeuOo_TxeMls5UcliPQ8op1jQkwBO0Bx0wDrsgEPCXU7nLIaJprt_D-icNQwu48omKZ48pkaGniJ1uz966jm79rrOsY-foPicMZPnAuOeMA6mqb5XJcfhinpXo6WpANOQ2YrCVq3us6jTkB2GJVfOyzi0XG_hf4V563lbI914RYqyiOGPhcJZdYQ9MivN4ASRKefS8z_giCfjcw"
Benjamin="Benjamin"#Benjamin="nf18217"#
setwd(paste("C:/Users/",Benjamin,"/OneDrive - University of Bristol/Documents/Projects/active/PH MR/gwas",sep=""))
...
##########################
#Finn r12, UKB, MVP HF
hf<-fread(paste("C:\\Users\\",Benjamin,"\\OneDrive - University of Bristol\\Documents\\Projects\\active\\GWAS\\meta_analysis_mvp_ukbb_summary_stats_I9_HEARTFAIL_meta_out.tsv.gz",sep=""))
...
ipf<-fread(paste("C:\\Users\\",Benjamin,"\\OneDrive - University of Bristol\\Documents\\Projects\\active\\GWAS\\meta_analysis_mvp_ukbb_summary_stats_IPF_meta_out.tsv.gz",sep=""))
...
#Finn r12, UKB, MVP PE
pe<-fread(paste("C:\\Users\\",Benjamin,"\\OneDrive - University of Bristol\\Documents\\Projects\\active\\GWAS\\meta_analysis_mvp_ukbb_summary_stats_I9_PULMEMB_meta_out.tsv.gz",sep=""))
...
copd<-fread(paste("C:\\Users\\",Benjamin,"\\OneDrive - University of Bristol\\Documents\\Projects\\active\\GWAS\\COPD_Bothsex_eur_inv_var_meta_GBMI_052021_nbbkgt1.txt.gz",sep=""))
...
asth<-fread(paste("C:\\Users\\",Benjamin,"\\OneDrive - University of Bristol\\Documents\\Projects\\active\\GWAS\\meta_analysis_ukbb_summary_stats_finngen_R12_J10_ASTHMA_MAIN_EXMORE_meta_out.tsv.gz",sep=""))
...
PH<-fread(paste("C:\\Users\\",Benjamin,"\\OneDrive - University of Bristol\\Documents\\Projects\\active\\PH MR\\gwas\\biobank phenotyping\\research letter\\meta_analysis_mvp_ukbb_summary_stats_I9_HYPTENSPUL_meta_out.tsv.gz",sep=""))
...
##########################################
#doing the analsyis 
#Non-cancer illness code self-reported: high cholesterol Dataset: ukb-a-108. From Pann UKBB

#LDL
#exp<-TwoSampleMR::extract_instruments("ukb-a-108",  opengwas_jwt = jwt, p2 = 5e-08, r2 = 0.001, kb = 10000)
#CAD
#exp<-TwoSampleMR::extract_instruments("ebi-a-GCST003116",  opengwas_jwt = jwt, p2 = 5e-08, r2 = 0.001, kb = 10000)


# chd<-fread(paste("C:\\Users\\",Benjamin,"\\OneDrive - University of Bristol\\Documents\\Projects\\active\\GWAS\\GCST90132314_buildGRCh37.tsv",sep=""))
# chd<-chd[chd$p_value < 5*10^-8,]; chd$pval<-chd$p_value
# chd$var2<-paste("",chd$chromosome,":",chd$base_pair_location,"",sep="")
# rsid<-fread(paste("C:\\Users\\",Benjamin,"\\OneDrive - University of Bristol\\Documents\\Projects\\active\\GWAS\\variants_nealUKB.tsv",sep="")) ; rsid<-as.data.frame(rsid) #build 37 stuff from the neil lab ukb gwas
# rsid$var2<-paste("",rsid$chr,":",rsid$pos,"",sep="")
# rsid<-rsid[rsid$var2%in%chd$var2,]
# chd<-merge(chd,rsid,by="var2");rsid<-NULL
# chd<-ieugwasr::ld_clump(  chd,  clump_kb = 10000,  clump_r2 = 0.001,  clump_p = 5*10^-8,  plink_bin = paste("C:/Users/",Benjamin,"/OneDrive - University of Bristol/Documents/Projects/active/clumping/plink_win64_20230116/plink.exe",sep=""),  bfile = paste("C:/Users/",Benjamin,"/OneDrive - University of Bristol/Documents/Projects/active/clumping/EUR",sep="") )
# chd$pheno<-"chd"
# exp<-format_data(as.data.frame(chd), type = "exposure",  phenotype_col = "pheno", snp_col = "rsid",  beta_col = "beta",  se_col = "standard_error",  eaf_col = "minfreq",  effect_allele_col = "effect_allele",  other_allele_col = "other_allele",  pval_col = "p_value",  id_col = "pheno",  chr_col = "chromosome",  pos_col = "base_pair_location")
# chd<-NULL

IHD<-fread(paste("C:\\Users\\",Benjamin,"\\OneDrive - University of Bristol\\Documents\\Projects\\active\\GWAS\\meta_analysis_mvp_ukbb_summary_stats_I9_IHD_meta_out.tsv.gz",sep=""))
IHD<-IHD[IHD$all_inv_var_meta_p < 5*10^-8,]; IHD$pval<-IHD$all_inv_var_meta_p
IHD<-ieugwasr::ld_clump(  IHD,  clump_kb = 10000,  clump_r2 = 0.001,  clump_p = 5*10^-8,  plink_bin = paste("C:/Users/",Benjamin,"/OneDrive - University of Bristol/Documents/Projects/active/clumping/plink_win64_20230116/plink.exe",sep=""),  bfile = paste("C:/Users/",Benjamin,"/OneDrive - University of Bristol/Documents/Projects/active/clumping/EUR",sep="") )
IHD$pheno<-"PE"
exp<-format_data(as.data.frame(IHD), type = "exposure",  phenotype_col = "pheno", snp_col = "rsid",  beta_col = "all_inv_var_meta_beta",  se_col = "all_inv_var_meta_sebeta",  eaf_col = "fg_af_alt",  effect_allele_col = "ALT",  other_allele_col = "REF",  pval_col = "all_inv_var_meta_p",  id_col = "pheno",  chr_col = "#CHR",  pos_col = "POS")
IHD<-NULL

# stroke<-fread(paste("C:\\Users\\",Benjamin,"\\OneDrive - University of Bristol\\Documents\\Projects\\active\\GWAS\\GCST90104539_buildGRCh37.tsv.gz",sep=""))
# stroke<-stroke[stroke$p_value < 5*10^-8,]; stroke$pval<-stroke$p_value
# stroke$var2<-paste("",stroke$chromosome,":",stroke$base_pair_location,"",sep="")
# rsid<-fread(paste("C:\\Users\\",Benjamin,"\\OneDrive - University of Bristol\\Documents\\Projects\\active\\GWAS\\variants_nealUKB.tsv",sep="")) ; rsid<-as.data.frame(rsid) #build 37 stuff from the neil lab ukb gwas
# rsid$var2<-paste("",rsid$chr,":",rsid$pos,"",sep="")
# rsid<-rsid[rsid$var2%in%stroke$var2,]
# stroke<-merge(stroke,rsid,by="var2");rsid<-NULL
# exp<-format_data(as.data.frame(stroke), type = "exposure",  header = TRUE, snp_col = "rsid", beta_col = "beta", se_col = "standard_error",  eaf_col = "effect_allele_frequency", effect_allele_col = "effect_allele", other_allele_col = "other_allele",pval_col = "p_value", chr_col = "base_pair_location", pos_col = "chromosome")
# stroke<-NULL


AF<-fread(paste("C:\\Users\\",Benjamin,"\\OneDrive - University of Bristol\\Documents\\Projects\\active\\GWAS\\meta_analysis_mvp_ukbb_summary_stats_I9_AF_meta_out.tsv.gz",sep=""))
...
## IHD
# id.exposure id.outcome outcome exposure                    method nsnp         b         se
# 1      vypWqL     fal4kx outcome       PE Inverse variance weighted  398 0.2816782 0.05013309
# pval
# 1 1.925011e-08
...
## IHD
# id.exposure id.outcome outcome exposure                    method nsnp           b         se
# 1      vypWqL     4Mszn1 outcome       PE Inverse variance weighted  387 -0.01284511 0.07156743
# pval
# 1 0.8575588
